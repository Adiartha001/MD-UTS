...
def main():
    ...
    # Test Case 1: Prediksi berdasarkan data yang sudah ditentukan
    if st.button('Test Case 1 (Confirmed)'):
        test_case_1 = {
    ...
    # Test Case 2: Prediksi berdasarkan data yang sudah ditentukan
    if st.button('Test Case 2 (Not Confirmed)'):
        test_case_2 = {
